## Project-1 : Static Website Hosting (Mini Project 1)
...
![AWS S3 CloudFront Architecture](Project-1.png)
...
```
Project-1/ Host-static-website-s3-cloudfront/
├── host-static-website-main.tf              # Main Terraform configuration
...
```bash
cd Project-1/ Host-static-website-s3-cloudfront
terraform init
```
